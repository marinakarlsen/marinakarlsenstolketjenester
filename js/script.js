...
const translations = {
    no: {
        ...
        omMegTitle: "Om meg",
        omMegHeader: "Om meg",
        omMegInnhold: "Som tolk jobber jeg i skjæringspunktet mellom språk, mennesker og presisjon. Jeg har alltid hatt interesse for hvordan vi kommuniserer – både det menneskelige og det strukturelle. Det var denne kombinasjonen som førte meg inn i tolkeyrket.\nJeg har jobbet som tolk i over tre år, med norsk og ukrainsk som arbeidsspråk – to språk jeg har som morsmål. I løpet av denne tiden har jeg tolket i en rekke ulike sammenhenger, og fått mange gode og takknemlige tilbakemeldinger fra både oppdragsgivere og brukere.\n Min vei inn i tolkeyrket startet med tospråktesten og TAO-kurset. Deretter tok jeg statsautorisasjonsprøven i tolking – en krevende, men lærerik prosess som endte med at jeg ble registrert i Nasjonalt tolkeregister i kategori C. Det å være statsautorisert tolk er noe jeg setter stor pris på, både fordi det er en anerkjennelse av kompetanse, og fordi det forplikter til høy faglig og etisk standard. Jeg har alltid hatt en interesse for språk og kommunikasjon. Gjennom kurs og utdanning har jeg fordypet meg i språk som tysk, russisk og engelsk, men det er mellom norsk og ukrainsk jeg tolker profesjonelt. Ved siden av tolkeoppdragene studerer jeg til sivilingeniør innen ingeniørfag og IKT – en utdanning som gir meg en strukturert og analytisk tilnærming også i tolkerollen.\nMotivasjonen min for å jobbe som tolk handler først og fremst om mennesker. Jeg ønsker å bidra til at alle skal få likeverdige tjenester og god oppfølging, uavhengig av hvilket språk de snakker. God tolkning handler ikke bare om språk, men også om tillit, nøyaktighet og medmenneskelighet.",
        },
    uk: {
        ...
        omMegTitle: "Про мене",
        omMegHeader: "Про мене",
        omMegInnhold: "Як перекладачка я працюю на перетині мови, людей і точності. Мене завжди цікавило, як ми спілкуємося – як з людської, так і зі структурної точки зору. Саме це поєднання й привело мене до професії перекладача.\nЯ працюю перекладачкою вже понад три роки, з норвезькою та українською як робочими мовами – обидві мови є для мене рідними. За цей час я перекладала в різних сферах і отримала багато позитивних і вдячних відгуків як від замовників, так і від користувачів послуг.\nМій шлях у перекладацьку діяльність почався з двомовного тесту та курсу з етики та відповідальності перекладача (TAO). Після цього я склала іспит на державну авторизацію перекладача – складний, але цінний процес, який завершився тим, що мене було зареєстровано в Національному реєстрі перекладачів у категорії C. Бути перекладачкою з державною авторизацією для мене означає багато – це і визнання моєї компетентності, і зобов’язання дотримуватися високих професійних та етичних стандартів.\nМене завжди приваблювали мови й комунікація. Завдяки курсам та освіті я поглиблено вивчала німецьку, російську й англійську, але професійно перекладаю саме між норвезькою та українською. Паралельно з перекладацькою діяльністю я навчаюся на інженерку в галузі інженерних наук та ІКТ – освіта, яка формує в мені структурований і аналітичний підхід, що корисний і в ролі перекладача.\nМоя мотивація працювати перекладачкою насамперед пов’язана з людьми. Я прагну зробити свій внесок у те, щоб кожна людина отримувала рівноцінні послуги та належну підтримку – незалежно від того, якою мовою вона говорить. Якісний переклад – це не лише про мову, а й про довіру, точність і людяність.",
    }
};
